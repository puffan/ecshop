...
<div class="block clearfix">
  <!--left start-->
  <div class="AreaL"> <!-- #BeginLibraryItem "/library/filter_attr.lbi" --><!-- #EndLibraryItem --> <!-- #BeginLibraryItem "/library/price_grade.lbi" --><!-- #EndLibraryItem --> <!-- TemplateBeginEditable name="左边区域" --> <!-- #BeginLibraryItem "/library/goods_related.lbi" -->
    <!-- {if $related_goods} -->
    <div class="box">
      <div class="box_1">

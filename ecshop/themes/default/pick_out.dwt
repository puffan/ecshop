...
<div class="block clearfix">
  <!--left start-->
  <div class="AreaL"> <!-- TemplateBeginEditable name="左边区域" --> <!-- #BeginLibraryItem "/library/categorys.lbi" --><!-- #EndLibraryItem --> <!-- #BeginLibraryItem "/library/goods_related.lbi" --><!-- #EndLibraryItem --> <!-- #BeginLibraryItem "/library/goods_fittings.lbi" --><!-- #EndLibraryItem --> <!-- #BeginLibraryItem "/library/goods_article.lbi" --><!-- #EndLibraryItem --> <!-- #BeginLibraryItem "/library/goods_attrlinked.lbi" --><!-- #EndLibraryItem --> <!-- TemplateEndEditable -->
    <div class="box">
      <div class="box_1">
  ...
  <div class="AreaR">
      ...
      <div class="box_1">
        ...
        <div class="boxCenterList">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <tr>
              <td bgcolor="#e5ecfb" style="border-bottom: 1px solid #DADADA"><img src="images/note.gif" alt="no alt" />&nbsp;&nbsp;<strong class="f_red">{$caption.name}</strong></td>
            </tr>
    ...
    <div class="box">
      <div class="box_1">
        <h3><span>{$lang.search_result} ({$count})</span> <a href="{$url}">更多>></a></h3>
        <div class="boxCenterList clearfix">
          ...
          <div class="goodsItem"> <a href="{$goods.url}"><img src="{$goods.thumb}" alt="{$goods.name|escape:html}" class="goodsimg" /></a><br />
            ...
            <a href="javascript:addToCart({$goods.id})" style="display:none"><img src="images/bnt_buy.gif" /></a> <a href="javascript:collect({$goods.id})"  style="display:none"><img src="images/bnt_coll.gif" /></a> <font class="f1">

...
<div class="prclist">
  <div class="displaylist">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="tdl"><span>{$cat.name|escape:html}</span>相关商品<b>{$pager.record_count}</b>个 </td>
  ...
  <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
    ...
    <div class="centerPadd">
      <div class="clearfix goodsBox" style="border:none;">
        ...
        <!-- {if $goods.goods_id} -->
        <div class="goodsItem"> <a href="{$goods.url}" class="img-box"><img src="{$goods.goods_thumb}" alt="{$goods.goods_name}" class="goodsimg" /></a>
        <div class="goods-info">
            <div class="goods-title"><a href="{$goods.url}" title="{$goods.name|escape:html}">{$goods.goods_name}</a></div>
            <div class="goods-ms">
              {$goods.goods_brief}
            </div>
            <div class="clearfix price-box">
              <div class="shop_s">{$goods.shop_price}</div>
              <a class="price-btn" href="{$goods.url}">立即购买</a>
            </div>
